#!/usr/bin/env python3
"""
Send August promotional image to West Yorkshire Marketplace WhatsApp group.
...
GROUP_ID = "120363412504090601@g.us"
...
def main():
    print(f"Sending promotional image to {GROUP_ID}...")
